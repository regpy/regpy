...
Which provides the regularization classes `RegularizationSetting` and `TikhonovRegularizationSetting` which are
...
from .general import RegularizationSetting,TikhonovRegularizationSetting
from . import linear
from . import nonlinear

__all__ = ["RegularizationSetting","TikhonovRegularizationSetting","linear","nonlinear"]
