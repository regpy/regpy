...
class ADMM(Solver):
    def __init__(self,  setting, data_fidelity, penalty, init_v1, init_v2, init_p1, init_p2, gamma = 1, regpar = 1, proximal_pars_data_fidelity = None, proximal_pars_penalty = None):
        super().__init__()
