...
class RadonAstra2D(Operator):
    ...
    """    
    def __init__(self,num_pix:int,num_det:int,angles:np.array,geom_type="parallel",beam_type="strip",det_pix_len=1.,source_to_origin = None,origin_to_detector=None) -> None:
