...
axes[0, 1].plot(*op.domain.eval_curve(exact_solution).z)
axes[0, 1].plot(*op.domain.eval_curve(mean).z)
axes[0, 1].plot(*op.domain.eval_curve(mean - std).z)
axes[0, 1].plot(*op.domain.eval_curve(mean + std).z)

axes[1, 0].set_title('sample reco')
axes[1, 0].plot(*op.domain.eval_curve(exact_solution).z)
axes[1, 0].plot(*op.domain.eval_curve(samples[-1]).z)
